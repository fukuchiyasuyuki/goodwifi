...
<head>
    ...
    <title>ぐっとWifi</title>
    <link rel="stylesheet" href="{{ mix('/assets/css/reset.css') }}">
    <link rel="stylesheet" href="{{ mix('/assets/css/validationEngine.jquery.css') }}">
    <link rel="stylesheet" href="{{ mix('/assets/css/contents.css') }}">
    <link rel="stylesheet" href="{{ mix('/assets/css/tablet.css') }}">
    <link rel="stylesheet" href="{{ mix('/assets/css/smart.css') }}">
    ...
    <script src="{{ asset('/assets/js/jquery.validationEngine-ja.js')}}"></script>
    ...
    <link rel="apple-touch-icon" href="{{ asset('/assets/img/logo144.png')}}" sizes="144x144">
    <link rel="icon" href="{{ asset('/assets/img/logo96.png')}}" sizes="96x96">
</head>
<body>
    <div id="page_body">
        <div id="header">
            <div class="header_txt center">
            <img src="{{ asset('/assets/img/form_title.jpg')}}">
            </div> 
        </div>
        <div id="contents">
            <div id="contents_in">
                ...
                <div id="n_area_10" class="navi_area center">
                    <img src="{{ asset('/assets/img/form_flow01_sp.png')}}" style="width: 100%;">
                </div>
                <div class="form_box">
                    <form id="form1" name="form1">
                        <div style="margin-bottom: 20px;">
                            ...
                            <div id="wimax_img" style="padding-top: 15px;padding-bottom: 15px;">
                                <img id="wi_img_normal" src="{{ asset('/assets/img/wimax_img.jpg')}}" style="border: 1px solid #d9d4d4;padding: 2px;max-width: 99.5%;">
                                <img id="wi_img_sp" src="{{ asset('/assets/img/wimax_img_sp.jpg')}}" style="border: 1px solid #d9d4d4;padding: 2px;max-width: 99%;">
                            </div>
                        </div>
                        <div id="plan_super_area">
                            <div class="plan_navi">
                                    ...
                                    <div class="left plan_navi_in">
                                        <div class="plan_navi_in_title">お申し込み内容</div>
                                            <div style="padding-top: 10px;padding-left: 10px;float: left;width: 100px;">
                                                <img id="n_t_0_img" src="{{ asset('/assets/img/device02.png')}}" style="max-height: 100px;border: 1px solid #c4bdbd;padding: 2px;">
                                                <img id="n_t_1_img" src="{{ asset('/assets/img/device01.png')}}" style="max-height: 100px;border: 1px solid #c4bdbd;padding: 2px;">
                                                <img id="n_t_2_img" src="{{ asset('/assets/img/device03.png')}}" style="max-height: 100px;border: 1px solid #c4bdbd;padding: 2px;">
                                                <img id="n_t_3_img" src="{{ asset('/assets/img/na01.png')}}" style="max-height: 100px;border: 1px solid #c4bdbd;padding: 2px;">
                                            </div>
                                            ...
                                            <div style="padding-top: 10px;padding-left: 10px;">
                                                ...
                                                <div id="n_s_0_img">
                                                    <img src="{{ asset('/assets/img/support.jpg')}}" style="max-height: 40px;border: 1px solid #c4bdbd;padding: 2px;">
                                                    <span style="position: relative;bottom: 15px;">安心サポートプラス</span>
                                                </div>
                                                <div id="n_s_1_img">
                                                    <img src="{{ asset('/assets/img/goodsupport.jpg')}}" style="max-height: 40px;border: 1px solid #c4bdbd;padding: 2px;">
                                ...
                                <div class="new_plan_select_in">
                                    <img src="{{ asset('/assets/img/saitann.png')}}" style="max-width: 700px;width: 100%;" id="saitan_img">
                                    <h2>お申込み台数</h2>
                                            ...
                                            <div class="selectArea">
                                                ...
                                                <div class="selectBox selectBox-wide" id="terminal_0_mess">
                                                    ...
                                                    <div style="border-top: 2px solid #ddd;padding-top: 15px;">
                                                        <img src="{{ asset('/assets/img/device_02.png')}}" style="max-height: 140px;">
                                                    </div>
                                                    <div class="right">
                                                        <div class="left terminal_detail">
                                                            <img src="{{ asset('/assets/img/tokutixyou01.png')}}" style="max-height: 140px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <label class="plan_label label_margin">
                                            <div class="selectArea">
                                                ...
                                                <div class="selectBox selectBox-wide" id="terminal_1_mess">
                                                    ...
                                                    <div style="border-top: 2px solid #ddd;padding-top: 15px;">
                                                        <img src="{{ asset('/assets/img/device_01.png')}}" style="max-height: 140px;">
                                                    </div>
                                                    <div class="right">
                                                        <div class="left terminal_detail">
                                                            <img src="{{ asset('/assets/img/tokutixyou02.png')}}" style="max-height: 140px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="selectArea">
                                                    ...
                                                    <div class="selectBox selectBox-wide selectBox-plan" id="color_0_mess">
                                                        ...
                                                        <div style="border-top: 2px solid #ddd;">
                                                            <img src="{{ asset('/assets/img/device02.png')}}" style="max-height: 180px;">
                                                        </div>
                                            ...
                                            <label class="plan_label label_margin">
                                                <div class="selectArea">
                                                    ...
                                                    <div class="selectBox selectBox-wide selectBox-plan" id="color_1_mess">
                                                        ...
                                                        <div  style="border-top: 2px solid #ddd;">
                                                            <img src="{{ asset('/assets/img/device01.png')}}" style="max-height: 180px;">
                                                        </div>
                                        ...
                                        <label class="plan_label label_margin plan_label_wide">
                                            <div class="selectArea">
                                                ...
                                                <div class="selectBox selectBox-wide" id="terminal_2_mess">
                                                    ...
                                                    <div style="border-top: 2px solid #ddd;padding-top: 15px;">
                                                        <img src="{{ asset('/assets/img/na01.png')}}" style="max-height: 170px;">
                                                    </div>
                                                    <div class="right">
                                            ...
                                            <div class="selectBox selectBox-plan selectBox-option" id="support_0_mess">
                                                <div style="display: flex;justify-content: center;padding-bottom: 15px;">
                                                    <div class="option_img">
                                                        <img src="{{ asset('/assets/img/support.jpg')}}">
                                                    </div>
                                    ...
                                    <label class="plan_label label_margin plan_label_left" >
                                        <div class="selectArea">
                                            ...
                                            <div class="selectBox selectBox-plan selectBox-option" id="protect_0_mess">
                                                <div style="display: flex;justify-content: center;padding-bottom: 15px;">
                                                    <div class="option_img">
                                                        <img src="{{ asset('/assets/img/goodsupport.jpg')}}">
                                                    </div>
                                                    <div class="planName planName_option">
                                                        ぐっとサポートに<br>
                                                        加入する
                        ...
                        <div class="popup" id="js-popup2">
                            <div class="popup-inner center">
                                ...
                                <div class="close-btn" id="js-close-btn"><i class="fas fa-times"></i></div>
                                        <img src="{{ asset('/assets/img/pop_01.png')}}" style="width: 75%;margin: 0 auto;" id="pop_01_0">
                                    <img src="{{ asset('/assets/img/pop_01_sp.png')}}" style="width: 75%;margin: 0 auto;" id="pop_01_1">
                        ...
                        <div class="popup" id="js-popup3">
                            <div class="popup-inner center">
                                ...
                                <img src="{{ asset('/assets/img/pop_02.png')}}" style="width: 75%;margin: 0 auto;" id="pop_02_0">
                                <img src="{{ asset('/assets/img/pop_02_sp.png')}}" style="width: 75%;margin: 0 auto;" id="pop_02_1">
                        ...
                        <div class="popup" id="js-popup4" onclick="pop_ctr_support_del_info_remove();">
                            <div class="popup-inner center" id="js-child4">
                                ...
                                <div class="close-btn" id="js-close-btn"><i class="fas fa-times"></i></div>
                                <img src="{{ asset('/assets/img/anshin_pop_pc.jpg')}}" style="width: 75%;margin: 0 auto;" id="pop_03_0">
                                <img src="{{ asset('/assets/img/anshin_pop_sp.jpg')}}" style="width: auto;margin: 0 auto;" id="pop_03_1">
                                <div style="padding-top: 30px;">
                                    <img src="{{ asset('/assets/img/pop_btn.png')}}" style="width: 75%;max-width:200px;margin: 0 auto;cursor: pointer;" id="pop_btn_0"  onclick="pop_btn_chg(0);">
                                    <img src="{{ asset('/assets/img/pop_btn_done.png')}}" style="width: 75%;max-width:200px;margin: 0 auto;cursor: pointer;display: none;" id="pop_btn_1" onclick="pop_btn_chg(1);">
                                </div>
                            </div>
                            <div class="black-background" id="js-black-bg"></div>
                        </div>
                        <div class="popup" id="js-popup5" onclick="pop_ctr_protect_del_info_remove();">
                            <div class="popup-inner center" id="js-child5">
                                ...
                                <div class="close-btn" id="js-close-btn"><i class="fas fa-times"></i></div>
                                <img src="{{ asset('/assets/img/gutto_pop_pc.jpg')}}" style="width: 75%;margin: 0 auto;" id="pop_04_0">
                                <img src="{{ asset('/assets/img/gutto_pop_sp.jpg')}}" style="width: auto;margin: 0 auto;" id="pop_04_1">
                                <div style="padding-top: 30px;">
                                    <img src="{{ asset('/assets/img/pop_btn.png')}}" style="width: 75%;max-width:200px;margin: 0 auto;cursor: pointer;" id="pop_btn_2"  onclick="pop_btn_chg2(0);">
                                    <img src="{{ asset('/assets/img/pop_btn_done.png')}}" style="width: 75%;max-width:200px;margin: 0 auto;cursor: pointer;display: none;" id="pop_btn_3" onclick="pop_btn_chg2(1);">
                                </div>
                            </div>
                            <div class="black-background" id="js-black-bg"></div>
                        </div>
                        <div class="form_main_contents" id="input_area">
                            ...
                            <form id="paidy-form" class="paidy-pay">
                                <div class="paidy-pay_view">
                                    <img src="{{ asset('/assets/img/paidy_logo.png')}}" alt="後払いペイディ">
                                </div>
